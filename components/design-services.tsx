    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-geist font-bold text-3xl md:text-4xl text-foreground mb-6">
              Hire Just the Design Services
            </h2>
            <p className="font-manrope text-lg text-muted-foreground mb-8 leading-relaxed">
            ...
            <Link href="/about">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-manrope font-medium cursor-pointer"
              >
                Know More →
              </Button>
            </Link>

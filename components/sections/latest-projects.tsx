      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover our recent work and see how we transform spaces into
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {displayProjects.map((project, index) => (
            <Card
              key={project.id}
              className="group overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.03] bg-white border-0 shadow-lg"
            >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-white/95 text-accent p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-20">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold font-serif text-lg md:text-xl text-foreground">
                        {project.title}
                      </h3>
                    </div>
                  </div>
        ...
        <div className="text-center">
          <Link href="/projects">
            <Button
              size="lg"
              className="cursor-pointer bg-gradient-to-r from-foreground to-foreground/90 hover:from-foreground/90 hover:to-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8 py-3 rounded-xl"
            >
              See More Projects
            </Button>
          </Link>
